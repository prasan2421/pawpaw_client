      ...
      <Grid container alignItems="center"
       spacing={2}>
        <Grid item xs={12} sm={7}>
          ...
          <p>Javascript | React.js | React Native | Node.js</p>
          <Box container sx={{marginTop:'50px', flex:1, justifyContent:'left',display: 'flex' }}>
  ...
  variant="body2"  onClick={() => {
    console.info("I'm a button.");
        ...
        <Grid item xs={12} sm={5}>
          ...
          <Box className="circle2" container alignItems="center" style={{marginTop:'10px',marginLeft:'10px'}} >
